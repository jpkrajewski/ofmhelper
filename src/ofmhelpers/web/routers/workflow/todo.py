"""
ofmhelpers/web/routers/workflow/todo.py
...
def _decorate_asset(t: dict) -> dict:
    ...
    job (see web/stores/jobs.py), if it has one. Shared by the full-page render and
...
async def upload_asset(
    ...
    name = require_upload_kind(file.filename, IMAGE_VIDEO_KINDS)
    ...
    todos.attach_asset(todo_id, str(dest), name)
